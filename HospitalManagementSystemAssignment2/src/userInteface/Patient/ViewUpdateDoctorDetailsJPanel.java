 ...
 * @author Dell
 */
public class ViewUpdateDoctorDetailsJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ViewUpdateDoctorDetailsJPanel
     */
    private Doctor doctor;
    private JPanel userProcessContainer1;
    private Boolean isEdit = Boolean.FALSE;
    
    public ViewUpdateDoctorDetailsJPanel(JPanel upc,Doctor doctor,Boolean isEdit) {
        initComponents();
    ...
    private void populatePatientDetails() {
        patientIDJTextField.setText(doctor.getDoctorID());
        primaryDocNameJTextField.setText(doctor.getPrimaryDoctorName());
